...
#define ARMA_USE_HDF5_ALT
  ...
  #define ARMA_HDF5_INCLUDE_DIR /usr/local/Cellar/hdf5/1.12.0_1/include/
#endif
...
#define ARMA_AUX_LIBS /usr/local/opt/openblas/lib/libopenblas.dylib;/usr/local/lib/libhdf5.dylib;/usr/local/lib/libsz.dylib;/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk/usr/lib/libz.tbd;/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk/usr/lib/libdl.tbd;/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk/usr/lib/libm.tbd;/usr/local/lib/libarpack.dylib;/usr/local/lib/libsuperlu.a
#define ARMA_AUX_INCDIRS /usr/local/Cellar/hdf5/1.12.0_1/include;/usr/local/opt/szip/include;/usr/local/include/superlu
